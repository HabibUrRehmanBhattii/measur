...
export default function AdminLoginPage() {
  ...
  const [renderKey, setRenderKey] = useState(0); // Add this to force re-render
  
  // Force a re-render on mount to ensure the component is fully client-side
  useEffect(() => {
  ...
  return (
    <div key={renderKey} className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900">
      <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg w-full max-w-md">
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-gray-500 mt-2">Default: admin / password</p>
        </div>
